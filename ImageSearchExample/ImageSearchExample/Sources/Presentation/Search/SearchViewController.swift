...
final class SearchViewController: UIViewController {
    ...
    func setupBindings(viewModel: SearchViewModelType = SearchViewModel()) {
        ...
        .bind(to: imagesCollectionView.rx.items(cellIdentifier: String(describing: ImageCollectionViewCell.self),
        ...
        viewModel.outputs.errorMessage
            .asObservable()
            .observeOn(MainScheduler.instance)
            .do(onNext: {[weak self] errorReason in
                guard let self = self else {return}
        ...
        imagesCollectionView.rx.itemSelected
            ...
            .subscribe(onNext: { [weak self] indexPath in
                ...
                let imageURL = viewModel.outputs.imagesCellItems.map { $0[indexPath.item].imageURL }
                detailImageViewController.bind(viewModel: DetailImageViewModel(imageURLString: imageURL))
